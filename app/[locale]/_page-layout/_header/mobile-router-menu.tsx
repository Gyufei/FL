    ...
    <div className="fixed left-0 top-[100px] z-10 h-[calc(100vh-100px)] w-screen bg-white p-4">
      ...
      >
        <Image
          ...
          alt="pools"
        />
        <div className="text-lg leading-5 text-black font-[700]">{t("btn-Dashboard")}</div>
      </div>
      <div
      ...
      >
        <div className="flex items-center justify-start space-x-3">
          <Image
            ...
            alt="governance"
          />
          <div className="text-lg leading-5 text-black font-[700]">
            {t("btn-Marketplace")}
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-start space-x-3">
          <Image
            ...
            alt="governance"
          />
          <div className="text-lg leading-5 text-black font-[700]">{t("btn-missions")}</div>
        </div>
      </div>
