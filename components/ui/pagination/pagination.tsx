...
export const PrevButton = ({ className, ...buttonProps }: ButtonProps) => {
  ...
  return (
    <button
      {...buttonProps}
      className={cn(
        "flex h-8 w-8 items-center justify-center rounded-lg bg-white text-sm leading-5 text-lightgray data-[active=true]:bg-theme data-[active=true]:text-white",
        className,
      )}
      onClick={() => previous()}
  ...
  const renderPageButton = (page: number) => (
    <li key={page}>
      <a
        ...
        className={cn(
          "flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg bg-white text-sm leading-5 text-lightgray data-[active=true]:bg-theme data-[active=true]:text-white",
          className,
        )}
      >
        {page}
