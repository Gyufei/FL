...
export default function ProjectOptions({
  ...
  return (
    <div className="fixed bottom-0 left-0 flex w-full max-w-md items-center justify-between bg-white px-6 pb-3 text-[14px] sm:absolute sm:left-auto sm:w-[320px] sm:px-0 sm:pb-0 ">
