...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DrawerPortal>
    ...
    >
      ...
      {children}
      {showClose && (
        <DrawerPrimitive.Close className="shadow-1 absolute right-4 top-1 flex h-8 w-8 items-center justify-center rounded-full border-none text-black outline-0 transition-opacity hover:bg-theme disabled:pointer-events-none">
          <X className="h-4 w-4" />
