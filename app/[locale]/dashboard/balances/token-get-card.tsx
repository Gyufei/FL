      ...
      <div className="mt-[10px] flex flex-col justify-between sm:items-end">
        ...
        >
          <button
            ...
            className={cn(
              "flex h-12 w-full cursor-pointer items-center justify-center rounded-lg border border-[#d3d4d6] hover:border-0 hover:bg-theme hover:text-white disabled:cursor-not-allowed disabled:opacity-70 sm:h-7 sm:w-14 sm:rounded-full",
